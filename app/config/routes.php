...
*/
$route['default_controller'] = 'site/form';
$route['404_override'] = 'pagenotfound';
$route['translate_uri_dashes'] = FALSE;
$route['index'] = 'site/form';
$route['getvalid'] = 'site/getvalid';
$route['success'] = 'site/success';
$route['listpendaftar'] = 'board/listpendaftar';
$route['exportcsv'] = 'board/exportcsv';
